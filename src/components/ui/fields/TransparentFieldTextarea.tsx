...
>(({ className,placeholder, ...rest }, ref) => {
	return (
		<textarea
			...
			autoFocus={false}
			className={cn(
				'bg-transparent overflow-y-auto placeholder:opacity-45 resize-none  focus:outline-0 focus:shadow-transparent w-full h-[150px] rounded-md border border-border p-2',
				className
			)}
			ref={ref}
			{...rest}
