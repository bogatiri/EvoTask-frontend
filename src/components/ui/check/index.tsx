const Checkbox = (props: {
	...
	return (
		<input
			id={id}
			type='checkbox'
			className={`defaultCheckbox relative inline-flex h-[20px] min-h-[20px] min-w-[20px]  w-[20px] appearance-none items-center opacity-40 hover:opacity-100 checked:opacity-100
      ...
      checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
				color === 'red'
					...
					: color === 'blue'
						...
						: color === 'green'
							? 'checked:bg-green-500 checked:border checked:border-dashed checked:border-gray-300 dark:checked:bg-green-400'
							: color === 'yellow'
